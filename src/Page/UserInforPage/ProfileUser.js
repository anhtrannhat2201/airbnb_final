...
const ProfileUser = () => {
    ...
    return (
        <div style={{ width: '30%', height: '400px' }} className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
            {avatar ? <img src={avatar} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" /> :
                <button
                    id="logo_Hoten"
                    style={{
                        width: 60,
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
                <div className="my-2 space-y-1">
                    <p className="block mt-3 mb-3 cursor-pointer text-dark hover:opacity-2 font-medium rounded-lg text-sm" data-toggle="modal" data-target="#uploadavatar" >
                        <ins>
                            Chỉnh Sửa Ảnh
                        </ins>
                    </p>
                </div>
                <div className="modal fade" id="uploadavatar" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title text-gray-800" id="exampleModalLabel">Chỉnh Sửa avatar</h1>
                            ...
                            <div className="modal-body">
                                ...
                                >
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <Form.Item>
                                            <button type="submit" className="bg-blue-400 text-dark py-2 px-1 rounded ">
                                                Cập nhật avatar
                                            </button>
                                        </Form.Item>
                                    </div>
